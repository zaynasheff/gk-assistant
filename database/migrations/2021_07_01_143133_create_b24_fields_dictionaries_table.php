...
class CreateB24FieldsDictionariesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('b24_fields_dictionaries', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('b24_fields_dictionaries');
    }
}
